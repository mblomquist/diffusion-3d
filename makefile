...
#
main3d.out : boundary3d.o initialize3d.o main3d.o output3d.o solver1d_tdma.o solver3d_bicgstab.o solver3d_bicgstab2.o solver3d_gmres.o solver3d_paradiso.o solver3d_tdma.o source3d.o
	ifort -o build/main3d.out -mkl build/boundary3d.o build/initialize3d.o build/main3d.o build/output3d.o build/solver1d_tdma.o build/solver3d_bicgstab.o build/solver3d_bicgstab2.o build/solver3d_gmres.o build/solver3d_paradiso.o build/solver3d_tdma.o build/source3d.o
...
clean :
	rm build/boundary3d.o build/initialize3d.o build/main3d.o build/output3d.o build/solver1d_tdma.o build/solver3d_bicgstab.o build/solver3d_bicgstab2.o build/solver3d_gmres.o build/solver3d_paradiso.o build/solver3d_tdma.o build/source3d.o
